...
.tabs a:hover {
   ...
   <a href="meena.html">Technical Events</a>
   <a href="meenant.html">Non Technical Events</a>
   <a href="meenaws.html">Workshop</a>
   <a href="certificate.html">Certificate</a>
   <a href="symcontact.html">Contact</a>
   </div>
        <br><br><br>
    <center>
        ...
        <div class="container">
            ...
            String sql = "select * from employee where firstname='"+fname+"' and lastname='"+lname+"'";
        ...
        <div class="reg">
            <a href="index.html" class="btn btn-primary">Home <i class="bi bi-house-door-fill"></i></a></div>
    </center>
    </body>
</html>